...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $studentDetails_id = $studentDetails->create($data);
        ...
        if ($studentDetails_id) {
            ...
            $studentDetails = [
                'id' => $studentDetails_id, // Use the obtained student ID
                'student_id' => $_POST['student_id'],
                'contact_number' => $_POST['contact_number'],
                'street' => $_POST['street'],
                'town_city' => $_POST['town_city'],
    ...
    <main id="main" class="main">
        <div class="pagetitle">
            <h1>Add Student Details Table</h1>
        </div>
                ...
                <form class="row g-3 needs-validation" method="post" novalidate>
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" id="validationCustom01"
                            placeholder="E.g. 1, 2, 3..." name="student_id" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" id="validationCustom01" placeholder="E.g. 09123456789..."
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" id="validationCustom02" placeholder="E.g. 714 Jevon Mission..."
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" id="validationCustom02" placeholder="E.g. 167..."
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" id="validationCustom02" placeholder="E.g. 927..."
