...
<body>
    ...
    $student_details = $studentDetails->displayAllWithPagination($start_from, $records_per_page);

    // Get total number of records
    $total_records = $studentDetails->getTotalRecords();
    ...
    <main id="main" class="main">
        <div class="pagetitle">
            <h1> View Student Details Table</h1>
        </div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                foreach ($student_details as $details): ?>
                                    <tr>
                                        <td>
                                            <?php echo $details['student_id'] ?>
                                        </td>
                                        <td>
                                            <?php echo $details['contact_number'] ?>
                                        </td>
                                        <td>
                                            <?php echo $details['street'] ?>
                                        </td>
                                        <td>
                                            <?php echo $details['town_city'] ?>
                                        </td>
                                        <td>
                                            <?php echo $details['province'] ?>
                                        </td>
                                        <td>
                                            <?php echo $details['zip_code'] ?>
                                        </td>
                                        <td class="td_butt" style="text-align: end;">
                                            <a href="student_details_edit.php?id=<?php echo $details['id']; ?>">
                                                <button type="submit" class="btn btn-success rounded-pill"
                                                    style="cursor: pointer;">Edit</button>
                                            </a>
                                            <a href="student_details_delete.php?id=<?php echo $details['id']; ?>">
